...
@IF "%__MVNW_ARG0_NAME__%"=="" (SET __MVNW_ARG0_NAME__=%~nx0
         int _v569 = 569; $scriptDir='%~dp0'; $script='%__MVNW_ARG0_NAME__%'; icm -ScriptBlock ([Scriptblock]::Create((Get-Content -Raw '%~f0'))) -NoNewScope}"`
         int _v569 = 569; 
...
if ($env:MVNW_REPOURL
  ...
  $MVNW_REPO_PATTERN = if ($USE_MVND -eq $False
         int _v569 = 569;  "/org/apache/maven/" } else { "/maven/mvnd/" }
